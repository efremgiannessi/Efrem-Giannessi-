      ...
      <div className="relative z-10 flex flex-col w-full max-w-5xl h-[90vh] max-h-[820px] rounded-3xl border border-white/20 bg-stone-950/95 shadow-2xl backdrop-blur-2xl text-stone-100 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="text-base sm:text-lg font-bold text-white tracking-wide">
                  Confronto Split-Screen: CAD 2D Tradizionale vs Modello BIM 3D Parametrico
                </h2>
                <span className="rounded bg-sky-500/20 px-2 py-0.5 text-[10px] font-mono font-bold text-sky-400 border border-sky-500/30">
                  DIGITAL TWIN
                </span>
              </div>
              <p className="text-xs text-stone-400 hidden xs:block">
                Trascina il cursore orizzontale per confrontare la tavola DWG 2D vettoriale con il modello parametrico Revit 5D
              </p>
            </div>
          </div>
        ...
        <div className="relative flex-1 bg-stone-900 select-none overflow-hidden" ref={containerRef}>
          ...
          <div className="absolute inset-0 bg-[#0d131f] flex items-center justify-center overflow-hidden">
            ...
            >
              ...
              <g transform="translate(180, 40) scale(0.9)">
                ...
                <g transform="translate(420, 180)">
                  <rect x="0" y="0" width="220" height="74" rx="8" fill="#020617" fillOpacity="0.9" stroke="#38bdf8" strokeWidth="1.5" />
            ...
            {/* BIM Badge */}
            <div className="absolute top-4 right-4 rounded-xl bg-amber-500/20 border border-amber-400/50 px-3 py-1.5 text-amber-300 backdrop-blur-md">
              <div className="flex items-center gap-1.5 text-xs font-bold font-mono">
                <Sparkles className="h-4 w-4 text-amber-400" />
                <span>MODELLO BIM 3D PARAMETRICO (Revit)</span>
              </div>
              <p className="text-[10px] text-stone-300">Dati integrati, stratigrafie, computo 5D automatico</p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              {/* CAD Badge */}
              <div className="absolute top-4 left-4 rounded-xl bg-rose-500/20 border border-rose-400/50 px-3 py-1.5 text-rose-300 backdrop-blur-md">
                <div className="flex items-center gap-1.5 text-xs font-bold font-mono">
                  <Layers className="h-4 w-4 text-rose-400" />
                  <span>DISEGNO CAD 2D TRADIZIONALE (.DWG)</span>
                </div>
                <p className="text-[10px] text-stone-300">Linee, tratteggi geometrici, nessun computo collegato</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="absolute top-1/2 -translate-y-1/2 h-10 w-10 rounded-full bg-amber-400 text-stone-950 font-bold shadow-xl border-2 border-white flex items-center justify-center transition-transform group-hover:scale-110 active:scale-95">
              <ArrowLeftRight className="h-4 w-4" />
            </div>

            <div className="absolute top-4 -translate-x-1/2 pointer-events-none whitespace-nowrap">
              <span className="px-2 py-0.5 rounded-full bg-stone-950/90 border border-amber-400 text-[10px] font-mono text-amber-300">
        ...
        <div className="px-4 sm:px-6 py-3 bg-stone-950 border-t border-white/10 grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
          <div className="flex items-start gap-2.5">
            <div className="h-6 w-6 rounded-lg bg-rose-500/20 text-rose-400 flex items-center justify-center shrink-0 mt-0.5">
              1
            </div>
            <div>
              <div className="font-semibold text-white">Sincronizzazione Automatica</div>
              <p className="text-[11px] text-stone-400">Nel CAD ogni vista (pianta, sezione) va ridisegnata a mano. Nel BIM il modello genera tutto in tempo reale.</p>
            </div>
          </div>

          <div className="flex items-start gap-2.5">
            <div className="h-6 w-6 rounded-lg bg-amber-500/20 text-amber-400 flex items-center justify-center shrink-0 mt-0.5">
              2
            </div>
            <div>
              <div className="font-semibold text-white">Computo 5D Integrato</div>
              <p className="text-[11px] text-stone-400">Dai muri CAD occorre calcolare le aree con formule manuali. In Revit il Quantity Takeoff è istantaneo al 100%.</p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div>
              <div className="font-semibold text-white">Zero Errori di Cantiere</div>
              <p className="text-[11px] text-stone-400">La Clash Detection rileva le interferenze tra travi e tubazioni prima ancora di posare la prima pietra.</p>
            </div>
          </div>
        </div>
      </div>
